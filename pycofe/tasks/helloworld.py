...
class HelloWorld(basic.TaskDriver):
    ...
    def run(self):
        ...
        # In the above call, self.rvrow is internal counter of rows of a grid
        # (invisible table), in which all graphical widgets are being laid.
        # Now we need to advance this counter, or table widget will be
        # substituted by next widget that we or jsCoFE framework may decide to
        # create:
